...
class StudentBattleshipOpponent(
    ...
    private fun checkShipsOverlap(ship1: Ship, ship2: Ship): Boolean {
    ...
    init {
        ...
        require(ships.zipWithNext().all { (ship1, ship2) -> !checkShipsOverlap(ship1, ship2) }) { "Ships cannot overlap" }
    }
