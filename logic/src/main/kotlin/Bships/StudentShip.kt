 ...
 class StudentShip(
    ...
    override val right: Int
     ...
     fun overlaps(other: StudentShip): Boolean {
         require(top in 0..9) { "Invalid top coordinate" }
         require(left in 0..9) { "Invalid left coordinate" }
         require(bottom in 0..9) { "Invalid bottom coordinate" }
         require(right in 0..9) { "Invalid right coordinate" }

         if (this.top > other.bottom || this.bottom < other.top || this.left > other.right || this.right < other.left) {
